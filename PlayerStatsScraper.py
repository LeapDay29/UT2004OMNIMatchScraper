...
fm_df.to_csv("playerbigmatches.csv", index = False)
...
# -------------------------------------------------------------- #
## PULL THE INDIVIDUAL PLAYER STATISTICS OF ALL THE SELECTED BIG MATCHES ##

# Load the new CSV file in
md = pd.read_csv("playerbigmatches.csv")
...
# Perform the scrape of ONLY the player statistics contained within qualifying match pages
